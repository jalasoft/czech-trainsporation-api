 ...
 */
final class TrainInfoRequester {

    private static final Logger LOGGER = LoggerFactory.getLogger(TrainInfoRequester.class);
    ...
    TrainInfoRequester(HttpClient httpClient) {
        this.httpClient = httpClient;
    }

    Train retrieveTrainInfo(String trainNumber) throws IOException, TrainNotFoundException, MalformedTrainInfoException {
        ...
        Train train = readTrainInfo(trainInfoPage);

        LOGGER.debug("Train info loaded: {}", train);
    ...
    private Train readTrainInfo(String trainInfoPage) {
        return null;
    }
}
